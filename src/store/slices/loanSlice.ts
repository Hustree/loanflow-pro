...
import type { Loan, CreateLoanPayloadSchema } from '@/features/loan-application/loan.schema';
...
export const loanSlice = createSlice({
  ...
  reducers: {
    ...
    updateLoanStatus: (
      state,
      action: PayloadAction<{ id: string; status: Loan['status']; notes: string }>,
    ) => {
...
export const { addLoan, updateLoanStatus, removeLoan, setLoading, setError, clearError, setLoans } =
  loanSlice.actions;
